...
import { attendanceFilterSummary, parseAttendanceFilter } from "@/lib/attendance-filters";
...
export async function GET(request: Request) {
  ...
  const buffer = await createMonitoringReport(data, { filterSummary: attendanceFilterSummary(filter) });
