...
export default async function DashboardPage() {
  ...
  const nonOperationalToday = !isOperationalSchoolDate(today, calendarEntry);
  ...
  const stats = user.role === "ADMIN" ? [
    ...
    { label: "Perlu konfirmasi", value: displayedPendingCount, detail: "catatan hari ini", icon: AlertCircle, tone: "red" },
  ] : [
    { label: "Siswa tidak hadir", value: displayedStudentCount, detail: "catatan hari ini", icon: GraduationCap, tone: "blue" },
    { label: "Guru tidak hadir", value: displayedTeacherCount, detail: "catatan hari ini", icon: UsersRound, tone: "amber" },
  ...
  const quickActions = user.role === "ADMIN" ? [
    ...
    ...(!nonOperationalToday ? [{ href: "/attendance", label: "Catat absensi", detail: "Siswa atau guru", icon: ClipboardPlus, tone: "blue" }] : []),
