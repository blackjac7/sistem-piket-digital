...
export function PasskeyLoginButton({ getUsername }: { getUsername: () => string }) {
  ...
  const label = status === "requesting" ? "Menunggu perangkat..." : status === "verifying" ? "Memverifikasi passkey..." : status === "redirecting" ? "Membuka ruang kerja..." : "Masuk dengan sidik jari / wajah";
